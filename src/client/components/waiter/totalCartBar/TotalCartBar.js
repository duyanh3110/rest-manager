      ...
      <div>
        <div className="formButton recipe">
          <div className="btn-grad btn-recipe">
            <img
              src="public/images/button/cancel.png"
              alt="logo"
              onClick={this.handleshowCancerModal}
            />
            <p onClick={this.handleshowCartModal}>3 Dishes</p>
            <img
              src="public/images/button/accept.png"
              alt="logo"
              onClick={this.handleshowFinalModal}
            />
          </div>
        </div>
        ...
        <Modal show={this.state.showFinalModal} onHide={this.handleCloseFinalModal}>
          <Modal.Body>
            ...
            <div className="formButton modal-btn">
              <Link to="/finalize" className="btn-grad btn-waiter">
                Confirm
              </Link>
            </div>
            <p className="back blue toscreen" onClick={this.handleCloseFinalModal}>
              Not yet
            </p>
          </Modal.Body>
        </Modal>
        ...
        <Modal
          dialogClassName="cartTemp"
          show={this.state.showCart}
          onHide={this.handleCloseCartModal}
        >
          <Modal.Body>
